...
public class TourRatingControllerTest {
    ...
    public void getAllRatingsForTour() throws Exception {
        List<TourRating> litsOfTourRatings = Arrays.asList(tourRatingMock);
        Page<TourRating> page = new PageImpl<>(litsOfTourRatings, PageRequest.of(0, 10), 1);
    ...
    /**
     * RestTemplate Patch only works if it uses httpclient. Method will only work
     * if:
